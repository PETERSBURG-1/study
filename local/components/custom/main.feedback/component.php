...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
	...
	if(check_bitrix_sessid())
	{
		if(empty($arParams["REQUIRED_FIELDS"]) || !in_array("NONE", $arParams["REQUIRED_FIELDS"]))
		{
			...
			if((empty($arParams["REQUIRED_FIELDS"]) || in_array("ENTER_SUBJECT", $arParams["REQUIRED_FIELDS"])) && mb_strlen($_POST["ENTER_SUBJECT"]) <= 3)
				$arResult["ERROR_MESSAGE"][] = GetMessage("MF_SUBJECT");
		}
		...
		$arResult["SUBJECT"] = htmlspecialcharsbx($_POST["ENTER_SUBJECT"]);
