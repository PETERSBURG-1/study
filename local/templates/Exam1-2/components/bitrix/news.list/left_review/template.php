			...
			<div class="inner-block">
				<div class="title">
					<div class="photo-block">
						<?
						$arResize = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array("width" => 49, "height" => 49), BX_RESIZE_IMAGE_PROPORTIONAL);
						?>
						<img src="<?=$arResize['src'] ? : $noPhoto?>" alt="<?=$arItem["PREVIEW_PICTURE"]["ALT"]?>">
					</div>
