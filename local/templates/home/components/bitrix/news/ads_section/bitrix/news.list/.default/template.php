              ...
              <div class="prop-more-info">
                <div class="inner d-flex">
                  ...
                  <div class="col">
                    ...
                    <strong><?=$arItem["DISPLAY_PROPERTIES"]["NUMBER_FLOORS"]["VALUE"]?></strong>
                  </div>
                  <div class="col">
                    <span><?=GetMessage('BATHROOMS')?></span>
                    <strong><?=$arItem["DISPLAY_PROPERTIES"]["NUMBER_BATHROOMS"]["VALUE"]?></strong>
                  </div>
                  <div class="col">
                    <span><?=GetMessage('GARAGE')?></span>
                    <strong><?=$arItem["DISPLAY_PROPERTIES"]["PRECENCE_GARAGE"]["VALUE"]?></strong>
                  </div>
                </div>
              </div>
            </div>
