              ...
              <div class="prop-more-info">
                <div class="inner d-flex">
                  ...
                  <div class="col">
                    ...
                    <strong><?=$arItem["PROPERTY_NUMBER_FLOORS_VALUE"]?></strong>
                  </div>
                  <div class="col">
                    <span><?=GetMessage('BATHROOMS')?></span>
                    <strong><?=$arItem["PROPERTY_NUMBER_BATHROOMS_VALUE"]?></strong>
                  </div>
                  <div class="col">
                    <span><?=GetMessage('GARAGE')?></span>
                    <strong><?=$arItem["PROPERTY_PRECENCE_GARAGE_VALUE"]?></strong>
                  </div>
                </div>
              </div>
            </div>
